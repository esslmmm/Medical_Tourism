        ...
        <main className="flex h-screen w-screen  bg-gray-100 flex-col items-center justify-center p-6">
            <div className="bg-white p-10 rounded-xl shadow-xl  w-full max-w-6xl text-center flex flex-col items-center h-full m-">
                ...
                <div className="relative w-40 h-40 mb-6">
                    <div className="w-40 h-40 rounded-full border bg-gray-300"></div>
                ...
                {/* User Details */}
                <div className="w-full bg-gray-50 p-8 rounded-lg shadow-md max-w-4xl flex flex-col gap-6">
                    <h2 className="text-3xl font-bold text-gray-700 text-center mb-4">Profile Details</h2>
                    <div className="text-2xl">
                        {(Object.keys(user) as Array<keyof UserProfile>).map((field, index) => (
                            <div key={index} className="flex flex-col items-start border border-gray-200 pb-3 transition-all hover:bg-gray-100 p-4 rounded-lg m-5">
                                ...
                                {editingField === field ? (
                                    ...
                                    <FiEdit2 className="text-gray-600 cursor-pointer hover:text-teal-600 transition-all self-end mb-10" size={20} onClick={() => handleEditClick(field)} />
                                )}
                            </div>
                        ))}
                    </div>
