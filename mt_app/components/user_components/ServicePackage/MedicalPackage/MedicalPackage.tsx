          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full border">
                  ...
                  <span className="font-bold text-sm text-black">English</span>
                </div>
                <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full border">
            ...
            <div>
              ...
              <div className="bg-white overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-4 text-black">Bangkok Hospital Phuket</h3>
                  <div className="mb-4">
                    <h4 className="font-bold mb-2 text-black">Location</h4>
                    <p className="text-black">Hongyok, Hongyokutis Rd, Taladyai, Muang, Phuket, Thailand</p>
                  </div>
                  <div className="mb-4">
                    <h4 className="font-bold mb-3 text-black">Centers & Clinics</h4>
                    <div className="flex flex-wrap gap-2">
                      <span className="bg-gray-800 text-white px-3 py-1 rounded text-sm font-bold">Oncology</span>
                      <span className="bg-gray-800 text-white px-3 py-1 rounded text-sm font-bold">Cardiovascular</span>
                      <span className="bg-gray-800 text-white px-3 py-1 rounded text-sm font-bold">Neuroscience</span>
                      <span className="border border-teal-500 text-teal-500 px-3 py-1 rounded text-sm font-bold">30+ service</span>
                    </div>
                  </div>
                  <button className="text-teal-500 font-bold">View Detail +</button>
                </div>
              </div>
            </div>
