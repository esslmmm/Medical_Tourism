    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
        {filteredDoctors.map((doctor) => (
          <div key={doctor.id} className="bg-white p-5 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition">
            {/* Doctor Image */}
            ...
            <p className="text-center text-gray-600 text-sm">{doctor.specialty}</p>
          </div>
        ))}
      </div>
