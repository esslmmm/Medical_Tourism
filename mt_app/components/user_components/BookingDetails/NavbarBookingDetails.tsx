        ...
        <nav className="flex items-center justify-between p-3 bg-[#F5F7FA] shadow-md">
            ...
            <div className="flex items-center gap-4">
                <div className="flex flex-col items-center">
                    <div className="w-6 h-6 flex items-center justify-center bg-blue-500 text-white rounded-full">1</div>
                    <span className="text-sm font-medium text-gray-500">Customer Info</span>
                </div>
                <div className="w-16 h-1 bg-black"></div>
                <div className="flex flex-col items-center ml-2">
                    <div className="w-6 h-6 flex items-center justify-center bg-gray-300 text-black rounded-full">2</div>
