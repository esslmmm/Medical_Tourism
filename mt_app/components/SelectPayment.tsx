    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md flex gap-8">
      ...
      <div className="w-2/3">
        ...
        <div className="mt-4 border rounded-lg overflow-hidden">
          {paymentMethods.map((method, index) => (
            <div
              key={index}
              className={`p-4 flex justify-between items-center border-b last:border-none cursor-pointer ${
                selectedMethod === method.name ? 'bg-gray-100' : 'bg-white'
              }`}
        ...
        <p className="text-sm text-gray-500 mt-4">
          By proceeding with this booking, I agree to Medical Tourism <a href="#" className="text-blue-500 underline">Terms of Use</a> and <a href="#" className="text-blue-500 underline">Privacy Policy</a>.
        </p>
      ...
      <div className="w-1/3 bg-white p-6 rounded-lg shadow">
        ...
        <div className="text-gray-700">
          <p className="flex justify-between"><span>Flight</span> <span>500 USD</span></p>
          <p className="flex justify-between"><span>Medical Service</span> <span>500 USD</span></p>
          <p className="flex justify-between"><span>Accommodation</span> <span>500 USD</span></p>
          <p className="flex justify-between"><span>Taxes and fee</span> <span>500 USD</span></p>
          <p className="flex justify-between text-red-500 font-bold mt-2">
            <span>50% discount</span> <span className="line-through text-gray-500">10,000 USD</span>
          </p>
