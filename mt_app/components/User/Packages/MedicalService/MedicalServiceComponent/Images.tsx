    ...
    <div>
      <div className="mt-5">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 relative">
          <div className="lg:col-span-2 relative h-[580px]">
            <Image
            ...
            {previewImages.slice(1, 3).map((img, i) => (
              <div key={i} className="relative">
                <Image
                  ...
                  width={400}
                  height={200}
                  className={`w-full h-full object-cover ${i === 0 ? "rounded-tr-2xl" : "rounded-br-2xl"
                    }`}
                />
                      ...
                      <div className="flex gap-4 overflow-x-auto py-2">
                        {images.map((img, i) => (
                          <button
                            ...
                            className={`flex-shrink-0 border-2 rounded-lg overflow-hidden ${selectedImage!.url === img.url
                                ? "border-teal-500"
                                : "border-transparent"
                              }`}
                          >
