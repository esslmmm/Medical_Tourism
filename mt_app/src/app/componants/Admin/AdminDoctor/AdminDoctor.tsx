    ...
    const person = [
        {
            ...
            Hospital: " MFU Medical Center Hospital",
            image: "/wat_rong_khun.jpg"
        },
        {
            name: "Dr. Valailuck Kiatthanakorn",
                    ...
                    {person.map((persons, index) => (
                        <div key={index} className="flex items-center border-b pb-4 mb-4">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-gray-600"><strong>Language :</strong> {persons.Specialization}</p>
                                <p className="text-gray-600"><strong>Location :</strong> {persons.Hospital}</p>
                            </div>
                        </div>
                    ))}
                </div>
