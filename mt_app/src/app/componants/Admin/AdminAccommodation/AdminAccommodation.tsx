                    ...
                    {locations.map((location, index) => (
                        <div key={index} className="flex items-center border-b pb-4 mb-4">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-gray-600"><strong>Contact Number :</strong> {location.Phone}</p>
                                <p className="text-gray-600"><strong>Location :</strong> {location.Location}</p>
                            </div>
                        </div>
                    ))}
                </div>
