  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-96 bg-gray-900">
        ...
        <button
          onClick={prevImage}
          className="absolute left-4 cursor-pointer top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white p-2 rounded-full transition"
        >
          <ChevronLeft className="w-6 h-6" />
        </button>
        <button
          onClick={nextImage}
          className="absolute right-4 cursor-pointer top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white p-2 rounded-full transition"
        >
          ...
          >
            {tabs.map((tab) => (
              <button
                ...
                className={`py-4 px-2 font-medium capitalize transition ${activeTab === tab
